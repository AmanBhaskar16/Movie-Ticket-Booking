    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <p>
            {formatTime(show.movie.runtime)}   .  {show.movie.genres.map(genre => genre.name).join(",  ")}  .  {show.movie.release_date.split("-")[0]}
          </p>
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            ...
            <a href="#dateSelect" className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer'>Buy Tickets</a>
            <button onClick = {handleFavorite} className='bg-gray-700 p-2.5 rounded-full transition cursor-pointer active:sclae-95'>
      ...
      <div className='overflow-x-auto no-scrollbar mt-8 pb-4'>
        {show.movie.casts.length > 0 ? <div className='flex items-center gap-4 w-max px-4'>
        ...
        </div>:<div className='flex justify-center items-center'><h2 className='text-primary text-lg'>Casts unavailable</h2></div>}
      </div>
